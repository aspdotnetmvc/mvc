<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgentEnterpriseManage.aspx.cs" Inherits="ZHSMSPlatform.Root.Enterprise.AgentEnterpriseManage" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <div class="navigation">首页 &gt; 代理商管理 &gt; 管理列表</div>
        <div class="tab_con">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            ...
                            &nbsp;&nbsp;或 &nbsp;&nbsp;维护渠道或客服：
                            <asp:TextBox ID="txt_ddlCM" runat="server" CssClass="txtInput" Height="25" Width="180" />
                           <%-- <asp:DropDownList ID="ddlCM" Width="160px" runat="server"></asp:DropDownList>--%>
                            &nbsp;&nbsp;&nbsp;
        ...
        <div>
            <asp:GridView ID="GridView1" CssClass="gridview" runat="server" AutoGenerateColumns="False" DataKeyNames="code,accountID"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="code" HeaderText="代理帐号" />
                    ...
                    <asp:HyperLinkField DataNavigateUrlFields="code" DataNavigateUrlFormatString="EnterpriseManageInfo.aspx?EnterpriseCode={0}" DataTextField="ChannelManager" HeaderText="渠道经理" Target="_self" />
                    <asp:HyperLinkField DataNavigateUrlFields="code" DataNavigateUrlFormatString="EnterpriseManageInfo.aspx?EnterpriseCode={0}" DataTextField="CSManager" HeaderText="维护客服" Target="_self" />
                    <asp:TemplateField HeaderText="资料编辑" Visible="false">
                        <ItemTemplate>
                            <a href="EnterpriseInfoEdit.aspx?type=Agent&&accountID=<%# Eval("code")%>">资料编辑</a>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="企业设置编辑">
                        <ItemTemplate>
                            <a href="EnterpriseEdit.aspx?type=Agent&&accountID=<%# Eval("code")%>">企业设置编辑</a>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="短信设置编辑" Visible="false">
                        <ItemTemplate>
                            <a href="EnterpriseSMSEdit.aspx?type=Agent&&accountID=<%# Eval("code")%>">短信设置编辑</a>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="密码重置">
                        <ItemTemplate>
                            <a href="EnterprisePass.aspx?type=Agent&&accountID=<%# Eval("code")%>">密码重置</a>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="密钥修改">
                        <ItemTemplate>
                            <a href="EnterpriseSecretKeyChange.aspx?type=Agent&&accountID=<%# Eval("code")%>">密钥修改</a>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="企业充值">
                        <ItemTemplate>
                            <a href="EnterpriseRecharge.aspx?type=Agent&&accountID=<%# Eval("code")%>">企业充值</a>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="余额查询">
                        <ItemTemplate>
                            <a href="EnterpriseBalance.aspx?type=Agent&&accountID=<%# Eval("code")%>">余额查询</a>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="充值记录">
                        <ItemTemplate>
                            <a href="EnterpriseRechargeRecord.aspx?type=Agent&&accountID=<%# Eval("code")%>">充值记录</a>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="详情">
                        <ItemTemplate>
                            <a href="EnterpriseDetails.aspx?type=Agent&&accountID=<%# Eval("code")%>">详情</a>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="短信管理">
                        <ItemTemplate>
                            <a href="SmsTab.aspx?type=Agent&&accountID=<%# Eval("code")%>">短信管理</a>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="企业短信统计">
                        <ItemTemplate>
                            <a href="../Report/EnterpriseSMSStatistics.aspx?type=Agent&&accountID=<%# Eval("code")%>">企业短信统计</a>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="取消代理商资格">
                        <ItemTemplate>
                            <asp:Button ID="btn" runat="server" CommandArgument='<%# Bind("code") %>'
                                CommandName="cancelAgent" Text="取消资格" Width="85px" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="代理商终端用户管理">
                        <ItemTemplate>
                            <a href="AgentLowerEnterpriseManage.aspx?type=Agent&&accountID=<%# Eval("code")%>">代理商终端用户管理</a>
                        </ItemTemplate>
                    </asp:TemplateField>
