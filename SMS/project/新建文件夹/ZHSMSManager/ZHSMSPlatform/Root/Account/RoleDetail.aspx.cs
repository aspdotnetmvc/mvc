...
namespace ZHCRM.Root.Account
{
    public partial class RoleDetail : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                string permissionValue = "System.Role.Detail";
        ...
        void load()
        {
            ...
            if (role != null)
            {
                ...
                lbl_remark.Text = role.Remark;
                lbl_name.Text = role.RoleName;
            }
            List<Model.Permission> per = BLL.Permission.GetRolePermissions(role.RoleID);
            LoadPermission(per);
        }
