<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KeywordGroupAdd.aspx.cs" Inherits="ZHSMSPlatform.Root.Keywords.KeywordGroupAdd" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <div class="navigation">首页 &gt; 敏感词管理 &gt; 敏感词组添加</div>
        <div class="tools_box">
            <div class="tools_bar">
        ...
        <div id="contentTab">
            <ul class="tab_nav">
                <li class="selected"><a onclick="tabs('#contentTab',0);" href="javascript:;">敏感词组添加</a></li>
            </ul>
            <div class="tab_con" style="display: block;">
                    ...
                    <table class="form_table">
                        ...
                        <tbody>
                            <tr>
                                <th>敏感词组：</th>
                                <td>
                                    <asp:TextBox ID="txt_keyGroup" runat="server" CssClass="txtInput normal required" MaxLength="32" />*
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server"
                                    ControlToValidate="txt_keyGroup" Display="Dynamic"
                                    ErrorMessage="请填写敏感词组">
                ...
                <div class="tab_con" style="display: block;">
                    <asp:GridView ID="GridView1" runat="server" CssClass="gridview" AutoGenerateColumns="False" DataKeyNames="Name"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Name" HeaderText="敏感词组" />
