...
{
    public partial class KeywordGroupAdd : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                string permissionValue = "Keywords.Manage.GroupAdd";
        ...
        private void load()
        {
            ...
            if (r.Success)
            {
                Dictionary<string, string> dic = r.Value;
            ...
            this.ViewState["KeywordsType"] = dt;
        ...
        protected void PageDropDownList_SelectedIndexChanged(Object sender, EventArgs e)
        {
            ...
            DataTable dt = (DataTable)this.ViewState["KeywordsType"];
            GridView1.DataSource = dt;
            GridView1.DataBind();
        }
