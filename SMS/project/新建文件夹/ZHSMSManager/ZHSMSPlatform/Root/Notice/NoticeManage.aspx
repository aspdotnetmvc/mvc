<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NoticeManage.aspx.cs" Inherits="ZHSMSPlatform.Root.Notice.NoticeManage" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="tab_con" style="display: block;">
            ...
            <div class="gonggao_box" id="tdInfo" runat="server" style="margin-top: -20px">
            </div>
        </div>
    </form>
</body>
