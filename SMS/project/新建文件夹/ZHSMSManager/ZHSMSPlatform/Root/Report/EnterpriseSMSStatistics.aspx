<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EnterpriseSMSStatistics.aspx.cs" Inherits="ZHSMSPlatform.Root.Report.EnterpriseSMSStatistics" %>
                    ...
                    <td colspan="10">
                        <asp:GridView ID="GridView1" CssClass="gridview" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="SendCount" HeaderText="发送数" />
                                <asp:BoundField DataField="SuccessCount" HeaderText="成功数" />
                                <asp:BoundField DataField="FailureCount" HeaderText="失败数" />
