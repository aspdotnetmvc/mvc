<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GatewayAdd.aspx.cs" Inherits="ZHSMSPlatform.Root.GatewayConfig.GatewayAdd" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <div class="navigation">
            <a href="javascript:history.go(-1);" class="back">后退</a>首页 &gt; 网关管理 &gt; 网关添加
        </div>
        <div class="tools_box">
            <div class="tools_bar">
                ...
                <table class="form_table">
                    ...
                    <tbody>
                        <tr>
                            <th>网关编号：</th>
                            <td>
                                <asp:TextBox ID="txt_gateway" Text="" runat="server" CssClass="txtInput" MaxLength="32"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
                                    ControlToValidate="txt_gateway" Display="Dynamic"
                                    ErrorMessage="*请填写网关编号">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:CheckBoxList ID="cb_operators" runat="server" RepeatDirection="Horizontal">
                                    <asp:ListItem Value="unicom" Selected="True">联通</asp:ListItem>
