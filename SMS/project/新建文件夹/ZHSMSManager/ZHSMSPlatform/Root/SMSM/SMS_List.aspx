<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SMS_List.aspx.cs" Inherits="ZHSMSPlatform.Root.SMSM.SMS_List" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="tab_con" style="display: block;">
            <table class="form_table">
                <tr>
                    <td>
                        <asp:Label ID="lbl_message" runat="server" Text="没有已提交但未发送的短信" Font-Bold="True" Font-Size="Medium"></asp:Label>
                        <asp:Label ID="Label1" runat="server" Text="" Font-Bold="True" Font-Size="Medium"></asp:Label>
                        <asp:GridView ID="GridView1" runat="server" CssClass="gridview" AutoGenerateColumns="False" DataKeyNames="SerialNumber"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="AccountID" Visible="false" HeaderText="企业帐号" />
