...
namespace SMSPlatService
{
    public partial class SMSPlatformService
    {
        ...
        {
            var ok = DAL.EnterpriseBlackList.AddEnterpriseBlackList(EnterpriseCode, Numbers);
            if (ok)
            {
                //添加缓存
        ...
        {
            var ok = DAL.EnterpriseBlackList.DelEnterpriseBlackList(EnterpriseCode, Numbers);
            if (ok)
            {
                //删除缓存
        ...
        {
            var list = DAL.EnterpriseBlackList.getEnterpriseBlackList(EnterpriseCode);
