...
namespace ZHSMSPlatHost
{
    class Program
    {
        ...
        {
            IntPtr windowHandle = FindWindow(null, "SMSPlatHost");
        ...
        static void Main(string[] args)
        {
            ...
            RemotingConfiguration.Configure("SMSPlatHost.exe.config", false);
