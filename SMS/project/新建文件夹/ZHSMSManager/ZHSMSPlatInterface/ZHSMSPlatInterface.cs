...
{
    public partial interface ISMService : IMonitoring
    {
        #region 外部使用接口
        ...
        /// <summary>
        /// 根据帐号获取短信状态明细（每次最多100条）
        /// </summary>
        /// <param name="account"></param>
        /// <param name="password"></param>
        /// <returns></returns>
        SMS.Model.RPCResult<List<SMS.Model.StatusReport>> GetReport(string account, string password);
        #endregion
        ...
        /// <returns></returns>
        SMS.Model.RPCResult UpdateAccountSecretKey(string account,string secretKey);
        /// <summary>
        /// 删除企业
        /// </summary>
        /// <param name="account"></param>
        ...
        /// <param name="account"></param>
        /// <returns></returns>
        RPCResult AddSysAccount(SMS.Model.SysAccount account);
        ...
        /// <param name="account"></param>
        /// <returns></returns>
        RPCResult UpdateSysAccount(SMS.Model.SysAccount account);
