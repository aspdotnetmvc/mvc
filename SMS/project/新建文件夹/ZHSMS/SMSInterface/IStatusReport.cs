...
namespace SMS.Model
{
    public partial interface ISMS : IMonitoring
    {
        ...
        /// <returns></returns>
        RPCResult<List<StatusReport>> GetSMSStatusReport(string smsid, DateTime sendTime);
        /// <summary>
        /// 获取MO短信（数据库获取）
        /// </summary>
        ...
        /// <param name="spNumber"></param>
        /// <returns></returns>
        RPCResult<List<MOSMS>> GetMOSmsBySPNumber(string accountID, string spNumber);
        /// <summary>
        /// 客户状态报告明细(缓存获取，获取后缓存删除)
        /// </summary>
        /// <param name="accountID"></param>
        /// <returns></returns>
        RPCResult<List<StatusReport>> GetCustomStatusReportBySerialNumber(string serialNumber);
        /// <summary>
