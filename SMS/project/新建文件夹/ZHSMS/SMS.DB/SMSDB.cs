...
namespace SMS.DB
{
    public partial class SMSDAL
    {
        ...
        {
            string sql = @"insert into SMS(ID,AccountID,SPNumber,Content,Signature,NumberCount,SendTime,SplitNumber,FeeTotalCount,AuditResult,AuditTime,AuditType,AuditAccountLoginName,Channel,SMSType,Status,Source)
        ...
        {
            string sql = @"insert into SMSNumber(ID,SMSID,Numbers,NumberCount,Operator,SendTime)
                       values(@ID,@SMSID,@Numbers,@NumberCount,@Operator,@SendTiem)";
