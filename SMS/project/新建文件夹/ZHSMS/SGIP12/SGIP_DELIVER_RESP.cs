...
namespace SGIP
{
    public class SGIP_DELIVER_RESP:ISGIP_MESSAGE
    {
        ...
        public SGIP_DELIVER_RESP(uint Result, string Reserve, uint SrcNodeSequence, uint DateSequence, uint Sequence_Id)
        {
            this._Header = new SGIP_MESSAGE(SGIP_MESSAGE.Length + Bodylength, SGIP_COMMAND.SGIP_DELIVER_RESP, SrcNodeSequence, DateSequence, Sequence_Id);
            this._Result = Result;
