...
namespace SMSService
{
    ...
    {
        static readonly string defaultSPNumber = ConfigurationManager.AppSettings["DefaultSPNumber"];
        ...
        public RPCResult<Guid> CreateAccount(Account account)
        {
            ...
            try
            {
                ...
                LogHelper.LogWarn("Pretreatment", "PretreatmentService.CreateAccount", "创建账号数据库失败");
                return new RPCResult<Guid>(false, guid, "创建账号失败！");
            }
            catch (Exception ex)
            {
                LogHelper.LogError("Pretreatment", "PretreatmentService.CreateAccount", ex.ToString());
        ...
        public RPCResult DelAccount(string accountID)
        {
            ...
            {
                LogHelper.LogWarn("Pretreatment", "PretreatmentService.DelAccount", "账号为空");
            ...
            try
            {
                ...
                LogHelper.LogWarn("Pretreatment", "PretreatmentService.DelAccount", "删除用户数据库操作失败");
                return new RPCResult(false, "删除用户失败！");
            }
            catch (Exception ex)
            {
                LogHelper.LogError("Pretreatment", "PretreatmentService.DelAccount", ex.ToString());
        ...
        public RPCResult<Account> GetAccount(string accountID)
        {
            if (string.IsNullOrEmpty(accountID))
            {
                LogHelper.LogWarn("Pretreatment", "PretreatmentService.GetAccount", "账号为空");
            ...
            {
                LogHelper.LogError("Pretreatment", "PretreatmentService.GetAccount", ex.ToString());
        ...
        public RPCResult<List<Account>> GetAccounts()
        {
            ...
            {
                LogHelper.LogError("Pretreatment", "PretreatmentService.GetAccounts", ex.ToString());
        ...
        public RPCResult AccountPrepaid(string accountID, uint quantity, string operatorAccount)
        {
            try
            {
                if (string.IsNullOrEmpty(accountID))
                {
                    LogHelper.LogWarn("Pretreatment", "PretreatmentService.AccountPrepaid", "充值账号为空");
                    return new RPCResult(false, "充值账号不能为空！");
                }
                Account account = AccountDB.GetAccount(accountID);//AccountServer.Instance.GetAccount(accountID);
                if (account == null)
                {
                    LogHelper.LogWarn("Pretreatment", "PretreatmentService.AccountPrepaid", "充值账号不存在");
                ...
                LogHelper.LogWarn("Pretreatment", "PretreatmentService.AccountPrepaid", "充值数据库操作失败");
                return new RPCResult(false, "充值失败");
            }
            catch (Exception ex)
            {
                LogHelper.LogError("Pretreatment", "PretreatmentService.AccountPrepaid", ex.ToString());
                return new RPCResult(false, "充值失败");
            }
        }
        /// <summary>
        ...
        public RPCResult AccountDeductSMSCount(string accountID, int quantity)
        {
            try
            {
                if (string.IsNullOrEmpty(accountID))
                {
                    LogHelper.LogWarn("Pretreatment", "PretreatmentService.AccountDeductSMSCharge", "账号为空");
                    return new RPCResult(false, "扣费账号不能为空！");
                }
                Account account =AccountDB.GetAccount(accountID);// AccountServer.Instance.GetAccount(accountID);
                if (account == null)
                {
                    LogHelper.LogWarn("Pretreatment", "PretreatmentService.AccountDeductSMSCharge", "账号不存在");
                    return new RPCResult(false, "账号不存在");
                }
                ...
                LogHelper.LogWarn("Pretreatment", "PretreatmentService.AccountDeductSMSCharge", "扣费数据库操作失败");
                return new RPCResult(false, "扣费失败");
            }
            catch (Exception ex)
            {
                LogHelper.LogError("Pretreatment", "PretreatmentService.AccountDeductSMSCharge", ex.ToString());
                return new RPCResult(false, "扣费失败");
            }
        }
        #endregion
        ...
        public RPCResult DelBlacklist(List<string> numbers)
        {
            try
            {
                ...
                LogHelper.LogWarn("Pretreatment", "PretreatmentService.DelBlacklist", "黑名单数据库删除失败");
                return new RPCResult(false, "删除黑名单失败");
            }
            catch (Exception ex)
            {
                LogHelper.LogError("Pretreatment", "PretreatmentService.DelBlacklist", ex.ToString());
        ...
        public RPCResult<List<string>> GetBlacklist()
        {
            ...
            {
                LogHelper.LogError("Pretreatment", "PretreatmentService.GetBlacklist", ex.ToString());
        ...
        public RPCResult AddKeywordsGroup(string keyGroup, string remark)
        {
            ...
            {
                LogHelper.LogError("Pretreatment", "PretreatmentService.AddKeywordsGroup", ex.ToString());
                return new RPCResult(false, "添加敏感词组失败");
            }
        }
        /// <summary>
        ...
        public RPCResult AddKeywordsType(string type, string remark)
        {
            ...
            {
                LogHelper.LogError("Pretreatment", "PretreatmentService.AddKeywordsType", ex.ToString());
                return new RPCResult(false, "添加敏感词类型失败");
            }
        }
        /// <summary>
        ...
        public RPCResult AddKeywordsGroupTypeBind(string keyGroup, List<string> keyTypes)
        {
            ...
            {
                LogHelper.LogError("Pretreatment", "PretreatmentService.AddKeywordsGroupTypeBind", ex.ToString());
                return new RPCResult(false, "添加敏感词组与类别绑定失败");
            }
        }
        /// <summary>
        ...
        public RPCResult<Dictionary<string, string>> GetKeywordsTypes()
        {
            ...
            {
                LogHelper.LogError("Pretreatment", "PretreatmentService.GetKeywordsTypes", ex.ToString());
        ...
        public RPCResult<List<string>> GetKeywordsTypesByGroup(string keyGroup)
        {
            ...
            {
                LogHelper.LogError("Pretreatment", "PretreatmentService.GetKeywordsTypesByGroup", ex.ToString());
        ...
        public RPCResult AddKeywords(string keyGroup, List<Keywords> keywords)
        {
            try
            {
                ...
                LogHelper.LogWarn("Pretreatment", "PretreatmentService.AddKeywords", "关键字添加数据库失败");
                return new RPCResult(false, "添加关键字失败");
            }
            catch (Exception ex)
            {
                LogHelper.LogError("Pretreatment", "PretreatmentService.AddKeywords", ex.ToString());
        ...
        public RPCResult DelKeywords(string keyGroup, List<string> keywords)
        {
            try
            {
                ...
                LogHelper.LogWarn("Pretreatment", "PretreatmentService.DelKeywords", "关键字删除数据库失败");
                return new RPCResult(false, "删除关键字失败");
            }
            catch (Exception ex)
            {
                LogHelper.LogError("Pretreatment", "PretreatmentService.DelKeywords", ex.ToString());
        ...
        public RPCResult DelKeywordGroup(string keyGroup)
        {
            ...
            {
                LogHelper.LogError("Pretreatment", "PretreatmentService.DelKeywordGroup", ex.ToString());
        ...
        public RPCResult<List<Keywords>> GetKeywords(string keyGroup)
        {
            ...
            {
                LogHelper.LogError("Pretreatment", "PretreatmentService.GetKeywords", ex.ToString());
        ...
        public RPCResult<List<Keywords>> GetKeywordsByType(string type)
        {
            ...
            {
                LogHelper.LogError("Pretreatment", "PretreatmentService.GetKeywordsByType", ex.ToString());
                return new RPCResult<List<Keywords>>(false, null, "获取失败");
            }
        }
        /// <summary>
        ...
        public RPCResult KeywordsEnabled(string keyGroup, string keywords, bool enabled)
        {
            ...
            {
                LogHelper.LogError("Pretreatment", "PretreatmentService.KeywordsEnabled", ex.ToString());
                return new RPCResult(false, "操作失败");
            }
        }
        /// <summary>
        ...
        public RPCResult UpdateKeywords(Keywords keyword)
        {
            ...
            {
                LogHelper.LogError("Pretreatment", "PretreatmentService.UpdateKeywords", ex.ToString());
                return new RPCResult(false, "更新失败");
            }
        }
        /// <summary>
        ...
        public RPCResult<Dictionary<string, string>> GetKeyGroups()
        {
            ...
            {
                LogHelper.LogError("Pretreatment", "PretreatmentService.GetKeyGroups", ex.ToString());
        ...
        public RPCResult AddkeyGroupGatewayBind(string keyGroup, string gateway)
        {
            try
            {
                ...
                LogHelper.LogWarn("Pretreatment", "PretreatmentService.AddkeyGroupGatewayBind", "关键词组绑定网关数据库操作失败");
                return new RPCResult(false, "关键词组绑定网关失败");
            }
            catch (Exception ex)
            {
                LogHelper.LogError("Pretreatment", "PretreatmentService.AddkeyGroupGatewayBind", ex.ToString());
                return new RPCResult(false, "关键词组绑定网关失败");
            }
        }
        /// <summary>
        ...
        public RPCResult<string> GetKeyGroupGatewayBinds(string gateway)
        {
            ...
            {
                LogHelper.LogError("Pretreatment", "PretreatmentService.GetKeyGroupGatewayBinds", ex.ToString());
        ...
        public RPCResult AddGatewayConfig(GatewayConfiguration config)
        {
            try
            {
                ...
                LogHelper.LogWarn("Pretreatment", "PretreatmentService.AddGatewayConfig", "网关添加数据库失败");
                return new RPCResult(false, "添加网关失败");
            }
            catch (Exception ex)
            {
                LogHelper.LogError("Pretreatment", "PretreatmentService.AddGatewayConfig", ex.ToString());
        ...
        public RPCResult UpdateGatewayConfig(GatewayConfiguration config)
        {
            try
            {
                ...
                LogHelper.LogWarn("Pretreatment", "PretreatmentService.UpdateGatewayConfig", "网关更新数据库失败");
                return new RPCResult(false, "更新网关失败");
            }
            catch (Exception ex)
            {
                LogHelper.LogError("Pretreatment", "PretreatmentService.UpdateGatewayConfig", ex.ToString());
        ...
        public RPCResult<GatewayConfiguration> GetGatewayConfig(string gateway)
        {
            ...
            {
                LogHelper.LogError("Pretreatment", "PretreatmentService.GetGatewayConfig", ex.ToString());
        ...
        public RPCResult<List<GatewayConfiguration>> GetGatewayConfigs()
        {
            ...
            {
                LogHelper.LogError("Pretreatment", "PretreatmentService.GetGatewayConfigs", ex.ToString());
        ...
        public RPCResult DelGatewayConfig(string gateway)
        {
            try
            {
                ...
                LogHelper.LogWarn("Pretreatment", "PretreatmentService.DelGatewayConfig", "网关删除数据库失败");
                return new RPCResult(false, "删除网关失败");
            }
            catch (Exception ex)
            {
                LogHelper.LogError("Pretreatment", "PretreatmentService.DelGatewayConfig", ex.ToString());
        ...
        public RPCResult AddChannel(Channel channel)
        {
            try
            {
                ...
                LogHelper.LogWarn("Pretreatment", "PretreatmentService.AddChannel", "通道添加数据库失败");
                return new RPCResult(false, "添加通道失败");
            }
            catch (Exception ex)
            {
                LogHelper.LogError("Pretreatment", "PretreatmentService.AddChannel", ex.ToString());
        ...
        public RPCResult UpdateChannel(Channel channel)
        {
            try
            {
                ...
                LogHelper.LogWarn("Pretreatment", "PretreatmentService.UpdateChannel", "通道更新数据库失败");
                return new RPCResult(false, "更新通道失败");
            }
            catch (Exception ex)
            {
                LogHelper.LogError("Pretreatment", "PretreatmentService.UpdateChannel", ex.ToString());
        ...
        public RPCResult<List<Channel>> GetChannels()
        {
            ...
            {
                LogHelper.LogError("Pretreatment", "PretreatmentService.GetChannels", ex.ToString());
        ...
        public RPCResult<Channel> GetChannel(string channel)
        {
            ...
            {
                LogHelper.LogError("Pretreatment", "PretreatmentService.GetChannel", ex.ToString());
        ...
        public RPCResult DelChannel(string channel)
        {
            try
            {
                ...
                LogHelper.LogError("Pretreatment", "PretreatmentService.DelChannel", "删除通道数据库操作失败");
                return new RPCResult(false, "删除通道失败");
            }
            catch (Exception ex)
            {
                LogHelper.LogError("Pretreatment", "PretreatmentService.DelChannel", ex.ToString());
        ...
        public RPCResult AddChannelGatewayBind(string channel, List<string> gateways)
        {
            try
            {
                ...
                LogHelper.LogWarn("Pretreatment", "PretreatmentService.AddChannelGatewayBind", "通道绑定网关数据库操作失败");
                return new RPCResult(false, "通道绑定网关失败");
            }
            catch (Exception ex)
            {
                LogHelper.LogError("Pretreatment", "PretreatmentService.AddChannelGatewayBind", ex.ToString());
                return new RPCResult(false, "通道绑定网关失败");
            }
        }
        /// <summary>
        ...
        public RPCResult<List<string>> GetGatewaysByChannel(string channel)
        {
            ...
            {
                LogHelper.LogError("Pretreatment", "PretreatmentService.GetGatewaysByChannel", ex.ToString());
        ...
        public RPCResult<List<string>> GetKeywordsGroupByType(string keyType)
        {
            ...
            {
                LogHelper.LogError("Pretreatment", "PretreatmentService.GetKeywordsGroupByType", ex.ToString());
        ...
        public RPCResult<List<Keywords>> GetKeywordsByKeyword(string keyword)
        {
            ...
            {
                LogHelper.LogError("Pretreatment", "PretreatmentService.GetKeywordsByKeyword", ex.ToString());
        ...
        public RPCResult<Dictionary<int, List<Keywords>>> GetAllKeywords(int pageIndex, int pageSize)
        {
            ...
            {
                LogHelper.LogError("Pretreatment", "PretreatmentService.GetAllKeywords", ex.ToString());
