<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditFailure_Test.aspx.cs" Inherits="WebSMS.Root.TestM.AuditFailureTest" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <div class="tools_box">
            <div class="tools_bar">
                <a href="../SMSM/AuditFailure.aspx" class="tools_btn"><span><b class="all">返回审核失败短信</b></span></a>
            </div>
        </div>
        <div class="tab_con" style="display: block;">
            <table class="form_table">
                <tr>
                    <td>
                        <asp:Label ID="lbl_message" runat="server" Text="没有批量确认审核失败短信" Font-Bold="True" Font-Size="Medium"></asp:Label>
        ...
        <div class="foot_btn_box">
            ...
            &nbsp;    
            <asp:Button ID="bt1" runat="server" Text="批量确认审核失败短信" CssClass="btnSubmit" OnClick="bt1_Click" />
            &nbsp; 
        </div>
    </form>
</body>
