...
{
    public partial class SMS_LevelTest : System.Web.UI.Page
    {
        ...
        protected void bt1_Click(object sender, EventArgs e)
        {
            ...
            string d = dd_l.SelectedItem.Text;
            for (int i = 0; i <= GridView1.Rows.Count - 1; i++)
            {
                ...
                if (CheckBox.Checked == true)
                {
                    ...
                    RPCResult r = PretreatmentProxy.GetPretreatment().SetSMSLevel(Guid.Parse(se), GetSMSLevelType(d));
                }
            }
            CheckBoxAll.Checked = false;
            CheckBox1.Checked = false;
            load();
            Message.Success(this, " 批量短信优先级调整,耗时" + (decimal)((DateTime.Now.Ticks - bt) / 10000000) + "秒", "null");
        }
