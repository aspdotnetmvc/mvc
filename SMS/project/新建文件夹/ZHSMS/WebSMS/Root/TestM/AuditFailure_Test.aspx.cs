...
{
    public partial class AuditFailureTest : System.Web.UI.Page
    {
        ...
        protected void bt1_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i <= GridView1.Rows.Count - 1; i++)
            {
                ...
                if (CheckBox.Checked == true)
                {
                    ...
                    RPCResult r = PretreatmentProxy.GetPretreatment().AffirmAuditFailureSMS(Guid.Parse(se));
                }
            }
            CheckBoxAll.Checked = false;
            CheckBox1.Checked = false;
            load();
            Message.Success(this, " 批量确认审核失败短信,耗时" + (decimal)((DateTime.Now.Ticks - bt) / 10000000) + "秒", "null");
