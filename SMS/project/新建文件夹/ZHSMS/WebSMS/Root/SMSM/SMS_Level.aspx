<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SMS_Level.aspx.cs" Inherits="WebSMS.Root.SMSM.SMS_Level" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="tab_con" style="display: block;">
            <table class="form_table">
                <tr>
                    <td>
                        <asp:Label ID="lbl_message" runat="server" Text="没有优先级调整短信" Font-Bold="True" Font-Size="Medium" Visible="true"></asp:Label>
