<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SMS_Audit.aspx.cs" Inherits="WebSMS.Root.SMSM.SMS_Audit" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="tab_con" style="display: block;">
            <table class="form_table">
                <tr>
                    <td>
                        <asp:Label ID="lbl_message" runat="server" Text="没有待发短信" Font-Bold="True" Font-Size="Medium"></asp:Label>
