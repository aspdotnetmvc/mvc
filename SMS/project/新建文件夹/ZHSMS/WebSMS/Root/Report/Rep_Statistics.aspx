<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Rep_Statistics.aspx.cs" Inherits="WebSMS.Root.Report.Rep_Statistics" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <div class="navigation">
            <a href="javascript:history.go(-1);" class="back">后退</a>首页 &gt;  统计状态报告
        </div>
        <div class="tools_box">
            <div class="tools_bar">
                <a href="Rep_StatisticsList.aspx" class="tools_btn"><span><b class="all">返回统计状态报告</b></span></a>
            </div>
        </div>
        <div class="tab_con" style="display: block;">
            <table class="form_table">
                <tr>
                    <td>
                        <asp:Label ID="lbl_message" runat="server" Text="没有统计状态报告" Font-Bold="True" Font-Size="Medium"></asp:Label>
                        ...
                        <asp:GridView ID="GridView1" SkinID="GridViewSkin" runat="server" AutoGenerateColumns="False" DataKeyNames="SerialNumber"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Account" HeaderText="账号编号" />

                                <asp:BoundField DataField="BeginSendTime" HeaderText="开始发送时间" />
                                <asp:BoundField DataField="LastResponseTime" HeaderText="最后接收报告时间" />
                              
                                <asp:BoundField DataField="SplitNumber" HeaderText="短信拆分条数" />
                                <asp:BoundField DataField="SendCount" HeaderText="总共发送条数" />
                                <asp:BoundField DataField="Succeed" HeaderText="总共成功数" />
                                <asp:BoundField DataField="FailureCount" HeaderText="总共失败数" />
