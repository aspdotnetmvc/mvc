<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Rep_LevelModifyRecordsList.aspx.cs" Inherits="WebSMS.Root.Report.Rep_LevelModifyRecordsList" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <div class="navigation">首页 &gt;  优先级调整记录</div>
                        ...
                        <asp:GridView ID="GridView1" SkinID="GridViewSkin" runat="server" AutoGenerateColumns="False" DataKeyNames="SerialNumber"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="操作">
                                    <ItemTemplate>
                                        <a href="Rep_LevelModifyRecord.aspx?SerialNumber=<%# Eval("SerialNumber")%>">查看优先级调整报告</a>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
