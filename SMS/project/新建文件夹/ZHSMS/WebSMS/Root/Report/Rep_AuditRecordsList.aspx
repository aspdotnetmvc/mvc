<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Rep_AuditRecordsList.aspx.cs" Inherits="WebSMS.Root.Report.Rep_AuditRecordsList" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <div class="navigation">首页 &gt;  审核记录</div>
                        ...
                        <asp:GridView ID="GridView1" SkinID="GridViewSkin" runat="server" AutoGenerateColumns="False" DataKeyNames="SerialNumber"
                            ...
                            <Columns>
                             ...
                             <%--   <asp:TemplateField HeaderText="操作">
                                    <ItemTemplate>
                                        <a href="Rep_AuditRecords.aspx?SerialNumber=<%# Eval("SerialNumber")%>">查看审核报告</a>
                                    </ItemTemplate>
                                </asp:TemplateField>--%>
                            </Columns>
