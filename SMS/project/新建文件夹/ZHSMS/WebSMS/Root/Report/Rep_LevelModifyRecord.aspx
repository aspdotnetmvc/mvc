<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Rep_LevelModifyRecord.aspx.cs" Inherits="WebSMS.Root.Report.Rep_LevelModifyRecord" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <div class="navigation">
            <a href="javascript:history.go(-1);" class="back">后退</a>首页 &gt;  优先级调整记录
        </div>
        <div class="tools_box">
            <div class="tools_bar">
                <a href="Rep_LevelModifyRecordsList.aspx" class="tools_btn"><span><b class="all">返回优先级调整记录</b></span></a>
            </div>
        </div>
