<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Rep_AuditRecords.aspx.cs" Inherits="WebSMS.Root.Report.Rep_AuditRecords" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <div class="navigation">
            <a href="javascript:history.go(-1);" class="back">后退</a>首页 &gt;  审核记录
        </div>
        <div class="tools_box">
            <div class="tools_bar">
                <a href="Rep_AuditRecordsList.aspx" class="tools_btn"><span><b class="all">返回审核记录</b></span></a>
            </div>
        </div>
                    ...
                    <td>
                        ...
                        <asp:GridView ID="GridView1" SkinID="GridViewSkin" runat="server" AutoGenerateColumns="False" DataKeyNames="SerialNumber"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Content" HeaderText="短信内容" />
