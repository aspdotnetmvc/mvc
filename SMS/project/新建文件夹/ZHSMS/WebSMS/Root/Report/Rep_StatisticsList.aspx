<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Rep_StatisticsList.aspx.cs" Inherits="WebSMS.Root.Report.Rep_StatisticsList" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <div class="navigation">首页 &gt;  统计状态报告</div>
                        ...
                        <asp:GridView ID="GridView1" SkinID="GridViewSkin" runat="server" AutoGenerateColumns="False" DataKeyNames="SerialNumber"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="操作">
                                    <ItemTemplate>
                                        <a href="Rep_Statistics.aspx?SerialNumber=<%# Eval("SerialNumber")%>">查看统计状态报告</a>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
