...
{
    public partial class Rep_AuditRecordsList : JudgeSession
    {
        ...
        private void load()
        {
            ...
            RPCResult<List<AuditRecord>> r = PretreatmentProxy.GetStatusReportService().GetAuditRecords(starttime, endtime);
            if (r.Success)
            {
                lbl_message.Visible = false;
                Label1.Text = "审核记录短信条数是：" + r.Value.Count;
