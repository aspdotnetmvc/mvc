<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrepaidRecord_List.aspx.cs" Inherits="WebSMS.Root.ACC.PrepaidRecord_List" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        <div class="navigation">首页 &gt; 充值记录</div>
        ...
        <div class="tab_con" style="display: block;">
            <table class="form_table">
                ...
                <tr>
                    <td colspan="10">
                        <asp:Label ID="lbl_message" runat="server" Text="没有充值记录" Font-Bold="True" Font-Size="Medium"></asp:Label>
                        <asp:Label ID="Label1" runat="server" Text="" Font-Bold="True" Font-Size="Medium"></asp:Label>
                        <asp:GridView ID="GridView1" SkinID="GridViewSkin" runat="server" AutoGenerateColumns="False" DataKeyNames="AccountID"
                            ...
                            <Columns>
                                <asp:BoundField DataField="AccountID" HeaderText="操作人" />
                                <asp:BoundField DataField="PrepaidAccount" HeaderText="充值帐号" />
                                <asp:BoundField DataField="Quantity" HeaderText="充值数" />
                                <asp:BoundField DataField="PrepaidTime" HeaderText="充值时间" />
                            </Columns>
