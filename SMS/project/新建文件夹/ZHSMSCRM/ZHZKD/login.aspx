<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="ZKD.login" %>
...
<head>
    ...
    <link href="css/load1.css" rel="Stylesheet" type="text/css" />
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#psw").focus(function () {
                $(this).css("background-image", "url(images/login/psw_2.jpg)");
            });
            $("#psw").blur(function () {
                if ($(this).val() === "") {
                    $(this).css("background-image", "url(images/login/psw_1.jpg)");
                }
            });
            ...
            if ($(window).height() <= 768) {
                $(".top").css("height", "80px");
                $(".load_box").css("right", "50px");
                $(".middle").css("height", "500px");
                $(".load_con").css("height", "500px");
            }
            $(window).resize(function () {
                if ($(window).height() <= 768) {
                    ...
                    $(".top").css("height", "144px");
                    $(".middle").css("height", "589px");
                    $(".load_con").css("height", "589px");
                    $(".load_box").css("right", "0px");
                }
            });
