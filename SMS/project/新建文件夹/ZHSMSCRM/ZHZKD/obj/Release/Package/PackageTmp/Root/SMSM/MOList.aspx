<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MOList.aspx.cs" Inherits="ZKD.Root.SMSM.MO_List" %>
...
<body>
    <form id="form1" runat="server">
        <div class="navigation">首页 &gt; 短信管理 &gt; 短信接收</div>
                ...
                <tr >
                    <td >
                        ...
                        <asp:GridView ID="GridView1" CssClass="gridview" runat="server" AutoGenerateColumns="False" DataKeyNames="SPNumber"
                            Width="70%" OnRowDataBound="GridView1_RowDataBound" AllowPaging="True" OnDataBound="GridView1_DataBound"
