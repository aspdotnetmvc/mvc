...
namespace LogClient
{
    public class Logger:IDisposable
    {
        ...
        {
            mqSend = new RabbitMQHelper(url, vhost, name, password);
            mqSend.BindQueue(channel, 10, channel);
