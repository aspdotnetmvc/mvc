...
namespace LogClient
{
    ...
    {
        readonly static Logger log = new Logger(ConfigurationManager.AppSettings["MQVHost"], ConfigurationManager.AppSettings["MQHost"], ConfigurationManager.AppSettings["MQUserName"], ConfigurationManager.AppSettings["MQPassword"], "LOG");
