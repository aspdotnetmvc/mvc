...
namespace LogHost
{
    public class Program
    {
        ...
        static void Main(string[] args)
        {
           ...
           var fr = new RabbitMQHelper(AppConfig.MQHost, AppConfig.MQVHost, AppConfig.MQUserName, AppConfig.MQPassword);
           fr.OnSubsribeMessageRecieve += fr_ReceiveMessage;
            fr.SubsribeMessage(AppConfig.MQChannel, AppConfig.MaxPriority);
        ...
        static void CreateSubmeter()
        {
            while (true)
            {
                ...
                SubmeterDate = DateTime.Now.ToString("yyyyMM");
