...
namespace SMS.DB
{
    public class ReportStatisticsDB
    {
        ...
        public static bool AddSMSHistory(ReportStatistics sms)
        {
            ...
            string sql = @"insert into " + tableName + @"(ID,AccountID,SPNumber,Content,Signature,NumberCount,SendTime,SplitNumber
                            ,FeeTotalCount,AuditResult,AuditTime,AuditType,AuditAccountLoginName,Channel,SMSType,Status,
                            Source,SMSLevel,StatusReportType,FilterType)
                            values(@ID,@AccountID,@SPNumber,@Content,@Signature,@NumberCount,@SendTime,@SplitNumber,
                            @FeeTotalCount,@AuditResult,@AuditTime,@AuditType,@AuditAccountLoginName,@Channel,@SMSType,@Status,
                            @Source,@SMSLevel,@StatusReportType,@FilterType)";
        ...
        public static ReportStatistics GetReportStatisticsBySMSID(string smsid, DateTime sendTime)
        {
