            ...
            function _1c5(_1c6, _1c7) {
                ...
                for (var i = 0; i < _1c7.length; i++) {
                    ...
                    for (var j = 0; j < _1c6; j++) {
                        cc.push("<span class=\"tree-indent treeico"+_1c6+"\"></span>");
                    }
                    var _1c8 = false;
                    cc.push("<span class=\"ismp_ico fa fa-bookmark-o\"></span>");
...
(function($) {
    ...
    function _219(_21a) {
        ...
        //var _21b = $("<div class=\"panel\"></div>").insertBefore(window.parent.body);
...
(function($) {
            ...
            for (var i = 0; i < _60c.length; i++) {
                ...
                for (var j = 0; j < cols.length; j++) {
                    ...
                    if (col.checkbox) {
                        ...
                        if (col.field) {
                            td.attr("field", col.field).attr("class", "ismp_td"+j);
    ...
    $.fn.datagrid.methods = {
        ...
        removeColumn: function (jq, _774) {
            return jq.each(function () {
                var _775 = $(this).datagrid("getPanel");
                _775.find("td[field=\"" + _774 + "\"]").remove();
                $(this).datagrid("getColumnOption", _774).hidden = true;
                $(this).datagrid("fitColumns");
            });
        }, 
        ...
        renderRow: function(_78d, _78e, _78f, _790, _791) {
            ...
            for (var i = 0; i < _78e.length; i++) {
                ...
                if (col) {
                    ...
                    cc.push("<td field=\"" + _793 + "\" " + cls + " " + _797 + " class='ismp_td"+i+"'>");
                    var _797 = "";
                    if (!col.checkbox) {
                        if (col.align) {
